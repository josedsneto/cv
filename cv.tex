...
\tagline{Recherche de stage de fin d’études — à partir de février 2026}
...
\cvevent{Ing\'enieur en Cybersecurit\'e}{Grenoble INP - ESISAR, UGA | LCIS}{Septembre 2025 --- Pr\'esent}{Valence --- France}

\begin{itemize}
\item Amélioration d’une plateforme d’authentification matérielle basée sur des PUF (Physical
Unclonable Function).
...
\cvevent{D\'eveloppeur Firmware}{Grenoble INP - ESISAR, UGA | Olyntec}{January 2025 --- June 2025}{Valence --- France}
...
\cvevent{Chercheur 5G}{LASSE/UFPA | Ericsson}{June 2022 --- Septembre 2024}{Belém --- Br\'esil}
...
\cvsection{Formation}
\cvevent{Double Dipl\^ome en Électronique, Informatique et Systèmes \& Ingénierie Électrique}{Grenoble INP - ESISAR, UGA \& Université Fédérale du Pará (UFPA)}
{Septembre 2024 -- Pr\'esent}{}
% \divider
\switchcolumn

% \newpage
% \cvevent{Licence d'ingénieur en Ingénierie Électrique}{Université Fédérale du Pará (UFPA)}{Février 
% 2020 -- Pr\'esent}{}
...
Étudiant passionné par l’intelligence artificielle, l’Internet des objets, les systèmes embarqués, les
télécommunications et l’électronique. Fort de deux ans d’expérience en laboratoire de R\&D, je possède 
une bonne capacité à travailler de manière autonome ou en équipe, ainsi que d’bonnes compétences
rédactionnelles en anglais. Depuis un an en France, j’ai participé à un projet à visée commerciale en 
collaboration avec une entreprise. Motivé, flexible et curieux, j’aime apprendre et relever de 
...
\cvskill{Portuguais - Native}{5} %% Supports X.5 values.
\divider
